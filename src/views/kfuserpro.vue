<template>
  <div class="kf_user">
     <div>
       <h2 style="text-align:center">KF用户注册协议</h2>
       <br /><br />
       <p>KF是一家面向未来的数字货币和数字资产流通交易社区，运营网站https://www.KF.com（以下称“本网站”或“网站”），该网站是一个专门供用户进行数字资产交易和提供相关服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。只要登陆该网站的自然人或其他主体均为本网站的用户，本协议表述之便利，以下使用“您”或其他第二人称。为了本协议表述之便利，我们和您在本协议中合称为“双方”，我们或您单称为“一方”。</p>
  <br />
<p>重要提示</p>
<p>我们在此特别提醒您：</p>
...
<p>因此数字资产买卖绝不适合绝大部分人士，需承受较高风险。您了解和理解此投资有可能导致部分损失或全部损失，所以您应该以能承受的损失程度来决定投资的金额。您了解和理解数字资产会产生衍生风险，所以如有任何疑问，建议先寻求理财顾问的协助。此外，除了上述提及过的风险以外，还会有未能预测的风险存在。您应慎重考虑并用清晰的判断能力去评估自己的财政状况及上述各项风险而作出任何买卖数字资产的决定，并承担由此产生的全部损失，我们对此不承担任何责任。</p>
<br />
<p>敬告您：</p>
...
<p>5 https://www.KF.com/为本网站唯一官方对外信息公布平台；</p>
<p>6 本网站任何服务均不接受信用卡支付；</p>
<p>7 本网站不接受来自美国及金融行动特别工作组（FATF）网站上列出的高风险和非合作辖区国家的用户注册为会员使用本网站任何服务；</p>
<p>8 禁止使用本网站从事洗钱、走私、商业贿赂等一切非法交易活动，若发现此类事件，本站将采取各种可使用之手段，包括但不限于冻结账户，通知相关权利机关等，我们不承担由此产生的所有责任并保留向相关人士追究责任的权利。</p>
<br />
<p>一、总则</p>
...
<p>4.1.4 本网站承诺为用户提供的其他服务。</p>
<p>4.2. 服务规则</p>
<p>您承诺遵守下列本网站服务规则：</p>
<p>4.2.1 您应当遵守法律法规、规章、及政策要求的规定，保证账户中所有数字资产来源的合法性，不得在本网站或利用本网站服务从事非法或其他损害本网站或第三方权益的活动，如发送或接收任何违法、违规、违反公序良俗、侵犯他人权益的信息，发送或接收传销材料或存在其他危害的信息或言论，未经本网站授权使用或伪造本网站电子邮件题头信息等。</p>
<p>4.2.2 您应当遵守法律法规并妥善使用和保管其本网站账号及密码、资金密码、和其注册时绑定的手机号码、以及手机接收的手机验证码的安全。您对使用其本网站账号和密码、资金密码、手机验证码进行的任何操作和后果承担全部责任。当您发现本网站账号、密码、或资金密码、验证码被未经其授权的第三方使用，或存在其他账号安全问题时，应立即有效通知本网站，要求本网站暂停本网站账号的服务。本网站有权在合理时间内对您的该等请求采取行动，但本网站对在采取行动前已经产生的后果（包括但不限于您的任何损失）不承担任何责任。您在未经本网站同意的情况下不得将本网站账号以赠与、借用、租用、转让或其他方式处分给他人。</p>
...
<p>4.3. 产品规则</p>
<p>4.3.1 币币交易产品规则</p>
<p>用户承诺在其进入本网站交易，通过本网站与其他用户进行币币交易的过程中良好遵守如下交易规则。</p>
<p>4.3.1.1 浏览交易信息</p>
<p>用户在本网站浏览币币交易信息时，应当仔细阅读交易信息中包含的全部内容，包括但不限于价格、委托量、手续费、买入或卖出方向，用户完全接受交易信息中包含的全部内容后方可</p>
点击按钮进行交易。
<p>4.3.1.2 提交委托</p>
<p>在浏览完交易信息确认无误之后用户可以提交交易委托。用户提交交易委托后，即用户授权本网站代理用户进行相应的交易撮合，本网站在有满足用户委托价格的交易时将会自动完成撮</p>
合交易而无需提前通知用户。
<p>4.3.1.3 查看交易明细</p>
<p>用户可以通过管理中心的交易明细中查看相应的成交记录，确认自己的详情交易记录。</p>
<p>4.3.1.4 撤销/修改委托，在委托未达成交易之前，用户有权随时撤销或修改委托。</p>
<br />
<p>五、本网站的权利和义务</p>
...
<p>5.7 如您连续一年未使用本网站会员账号和密码登录本网站，则本网站有权注销您的本网站账号。账号注销后，本网站有权将相应的会员名开放给其他用户注册使用。</p>
<p>5.8 本网站通过加强技术投入、提升安全防范等措施保障您的法币及数字资产的安全，有义务在您账户出现可以预见的安全风险时提前通知您。</p>
...
<p>8.9 用户注册后即表示认可我们按照本协议中规定的规则进行的任何操作，产生的任何风险均由用户承担。</p>
<br />
<p>九、协议的终止</p>
...
<p>10.3 您接受本协议即视为您主动将其在本网站发表的任何形式的信息的著作权，包括但不限于：复制权、发行权、出租权、展览权、表演权、放映权、广播权、信息网络传播权、摄制权、改编权、翻译权、汇编权以及应当由著作权人享有的其他可转让权利无偿独家转让给本网站所有，本网站有权利就任何主体侵权单独提起诉讼并获得全部赔偿。本协议效力及于您在本网站发布的任何受著作权法保护的作品内容，无论该内容形成于本协议签订前还是本协议签订后。</p>
...
<br />
<p>十六、协议的生效和解释</p>
<p>16.1 本协议于您点击本网站注册页面的同意注册并完成注册程序、获得本网站账号和密码时生效，对我们和您均具有约束力。</p>
<p>16.2 本协议的最终解释权归我们所有。</p>
     </div>
  </div>
</template>
<script>
