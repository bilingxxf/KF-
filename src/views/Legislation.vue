<template>
  <div class="legislation">
    ...
    <br /><br />
    <p>第一条</p>
    <p>本网站的宗旨是在不违相关法律法规的前提下，尽可能地为全球广大数字资产爱好者及投资者提供专业的国际化水准的交易平台和金融产品。禁止使用本网站从事洗钱、走私、商业贿赂等一切非法交易活动，若发现此类事件，本站将冻结账户，立即报送有权机关。</p>
    <br />
    <p>第二条</p>
    ...
    <br />
    <p>第五条</p>
    <p>本声明未涉及的问题参见有关法律法规，当本声明与相关法律法规冲突时，以相关法律法规为准。</p>
