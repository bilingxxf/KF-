        ...
        widget: function (a) {
          ...
          var b = {
            ...
            symbolSearchRequestDelay: a.symbol_search_request_delay
                ...
                a.preset && (a = a.preset,
          n[a] ? (a = n[a],
          this.options.disabledFeatures = this.options.disabledFeatures.length > 0 ? this.options.disabledFeatures.concat(a.disabledFeatures) : a.disabledFeatures,
          this.options.enabledFeatures = this.options.enabledFeatures.length > 0 ? this.options.enabledFeatures.concat(a.enabledFeatures) : a.enabledFeatures) : console.warn('Unknown preset: `' + a + '`'))
